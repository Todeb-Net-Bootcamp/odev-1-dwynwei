...
namespace Patika.Dev_Abstract_Class_Hw
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            TODEBCard creditCard = new CreditCard("PLATINUM","VISA","1111-2222-3333-4444",dt,"Çağatay Şahin");

            // TODEBCard Abstact sınıfından inherit edilen DigitalCard sınıfına ait obje oluşturma bölümü
            TODEBCard digitalCard = new DigitalCard("GOLD", "MasterCard", "1111-2222-3333-4444", dt, "Çağatay Şahin",digitalWalletId);

            // TODEBCard Abstact sınıfından inherit edilen Debit(Hesap) Kartı sınıfına ait obje oluşturma bölümü
            TODEBCard debitCard = new DebitCard("BRONZE", "MasterCard", "1111-2222-3333-4444", dt, "Çağatay Şahin");
